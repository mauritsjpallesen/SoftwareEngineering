...
/***
 * @summary This is the class that is used to draw the nodes generated by the layout algorithm.
 */
public class Visualizer {
    ...
    /***
     * @summary This function generates and saves the actual image file.
     * @param DCRgraph the graph to visualize.
     * @param String the output name of the image
    ...
    private int countOccurrencesInString(char c, String str) {
        int count = 1;
